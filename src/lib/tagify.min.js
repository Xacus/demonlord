...
!(function (t, e) {
  ...
  function c(t, e, i) {
    function s(t, e) {
      for (var i in e)
        e.hasOwnProperty(i) && (f(e[i]) ? (f(t[i]) ? s(t[i], e[i]) : (t[i] = Object.assign({}, e[i]))) : (t[i] = e[i]))
    }
    ...
    (t.prototype = {
      ...
      templates: {
        wrapper: function (t, e) {
          return '<tags class="tagify '
            ...
            .concat(t.className, '"\n                        ')
            .concat(
              e.readonly ? 'readonly aria-readonly="true"' : 'aria-haspopup="listbox" aria-expanded="false"',
        ...
        dropdown: function (t) {
          var e = t.dropdown,
            i = ''
              .concat('manual' == e.position ? '' : 'tagify__dropdown tagify__dropdown--'.concat(e.position), ' ')
              .concat(e.classname)
              .trim()
      ...
      applySettings: function (i, t) {
        ...
        if (
          ...
          (this.settings.placeholder = i.getAttribute('placeholder') || this.settings.placeholder || ''),
        ...
        'select' == this.settings.mode && (this.settings.dropdown.enabled = 0),
          'mix' == this.settings.mode && (this.settings.autoComplete.rightKey = !0)
      },
      ...
      getCSSVars: function () {
        ...
        this.CSSVars = {
          tagHideTransition:
            ...
            })(((i = 'tag-hide-transition'), s.getPropertyValue('--' + i)))),
            (e = t.value),
            's' == t.unit ? 1e3 * e : e),
        }
      },
          ...
          (this.trigger = function (t, e) {
            ...
            if (t)
              if (n.settings.isJQueryPlugin)
                'remove' == t && (t = 'removeTag'), jQuery(n.DOM.originalInput).triggerHandler(t, [e])
              else {
                try {
                  var s = c({}, e)
                  ;(s.tagify = this), (i = new CustomEvent(t, { detail: s }))
                } catch (t) {
                  console.warn(t)
                }
                a.dispatchEvent(i)
      ...
      loading: function (t) {
        return (this.state.isLoading = t), this.DOM.scope.classList[t ? 'add' : 'remove']('tagify--loading'), this
      },
          ...
          if (!this.state.mainEvents || !i)
            for (var a in ((this.state.mainEvents = i) &&
              ...
              (this.DOM.input.addEventListener(
                ...
                s[this.isIE ? 'onInputIE' : 'onInput'].bind(this),
              ),
            ...
            (e = this.listeners.main =
              ...
              ('blur' == a && !i) || this.DOM[e[a][0]][n](a, e[a][1])
        },
        callbacks: {
          onFocusBlur: function (t) {
            var e = t.target ? t.target.textContent.trim() : '',
              ...
              o =
                t.relatedTarget &&
                t.relatedTarget.classList.contains('tagify__tag') &&
                this.DOM.scope.contains(t.relatedTarget),
              r = this.state.actions.selectOption && (n || !i.dropdown.closeOnSelect),
              l = this.state.actions.addNew && n
            if (!o) {
              if ('blur' == s && t.relatedTarget === this.DOM.scope)
              ...
              if (!r && !l)
                if (
                  ...
                  if ('focus' == s)
                    return this.trigger('focus', a), void (0 === i.dropdown.enabled && this.dropdown.show.call(this))
                  'blur' == s &&
                    (this.trigger('blur', a),
                    this.loading(!1),
          ...
          onKeydown: function (t) {
              ...
              switch (t.key) {
                ...
                case 'Backspace':
                  ...
                  var i = document.getSelection(),
                    n = 'Delete' == t.key && i.anchorOffset == i.anchorNode.length,
                    a = 1 == i.anchorNode.nodeType || (!i.anchorOffset && i.anchorNode.previousElementSibling),
                    o = d(this.DOM.input.innerHTML),
                    r = this.getTagElms()
                  if (
                    (3 == i.anchorNode.nodeType &&
                      !i.anchorNode.nodeValue &&
                      i.anchorNode.previousElementSibling &&
                      t.preventDefault(),
                  ...
                  setTimeout(function () {
                    ...
                    if (
                      ((i.anchorNode == s.DOM.input && t.length == o.length) ||
                        (!i.anchorOffset && t.length >= o.length)) &&
                      (s.removeTag(i.anchorNode.previousElementSibling),
                      s.fixFirefoxLastTagNoCaret(),
                      2 == s.DOM.input.children.length && 'BR' == s.DOM.input.children[1].tagName)
                    )
                      return (s.DOM.input.innerHTML = ''), !(s.value.length = 0)
                    s.value = [].map
                      .call(r, function (t, e) {
                        var i = t.__tagifyTagData
                        if (t.parentNode) return i
                        s.trigger('remove', { tag: t, index: e, data: i })
                      })
                      .filter(function (t) {
                        return t
                      })
            ...
            switch (t.key) {
              ...
              case 'ArrowDown':
                ...
                break
              case 'ArrowRight':
                var l = this.state.inputSuggestion || this.state.ddItemData
                if (l && this.settings.autoComplete.rightKey) return void this.addTags([l], !0)
                break
              case 'Tab':
              ...
              e
                ? this.input.value != e &&
                  ...
                  -1 != e.search(this.settings.delimiters)
                    ...
                    : 0 <= this.settings.dropdown.enabled && this.dropdown[i ? 'show' : 'hide'].call(this, e))
          ...
          onMixTagsInput: function () {
            ...
            if (window.getSelection && 0 < (o = window.getSelection()).rangeCount && 3 == o.anchorNode.nodeType) {
              if (
                ((t = o.getRangeAt(0).cloneRange()).collapse(!0),
                t.setStart(o.focusNode, 0),
                (s = (e = t.toString().slice(0, t.endOffset)).split(d.pattern).length - 1),
                (i = e.match(d.pattern)) && (n = e.slice(e.lastIndexOf(i[i.length - 1]))),
                n)
              ) {
                ;(this.state.actions.ArrowLeft = !1),
                  ...
                  (a = this.state.tag.value.length >= d.dropdown.enabled)
                try {
                  ;(r =
                ...
                ;(r || s < this.state.mixMode.matchedPatternCount) && (a = !1)
              } else this.state.flaggedTags = {}
              this.state.mixMode.matchedPatternCount = s
            }
            setTimeout(function () {
              l.update(),
                l.trigger('input', c({}, l.state.tag, { textContent: l.DOM.input.textContent })),
                l.state.tag && l.dropdown[a ? 'show' : 'hide'].call(l, l.state.tag.value)
            }, 10)
          },
          ...
          onClickScope: function (t) {
            ...
            if (t.target != this.DOM.scope) {
              if (!t.target.classList.contains('tagify__tag__removeBtn'))
                return e
                  ? (this.trigger('click', {
                      tag: e,
                  ...
                  : void (t.target == this.DOM.input && 500 < s
                      ? this.state.dropdown.visible
                        ? this.dropdown.hide.call(this)
          ...
          onDoubleClickScope: function (t) {
            var e,
              ...
              n = this.settings
            s &&
              ((e = s.classList.contains('tagify__tag--editable')),
      ...
      fixFirefoxLastTagNoCaret: function () {
        ...
        if (o && t.childNodes.length && 1 == t.lastChild.nodeType)
        ...
        if (s) {
          if (!(a instanceof Object && 'editable' in a) || a.editable)
            return (
              ...
              t.skipValidation || (l = this.editTagToggleValidity(e, a.value)),
              (s.originalIsValid = l),
      ...
      onEditTagDone: function (t, e) {
        ...
        this.trigger('edit:beforeUpdate', s),
          ...
          this.dropdown.hide.call(this),
          !0 === e.__isValid &&
            this.getTagElms('tagify--notAllowed').forEach(function (t) {
              var e = i.validateTag(t.__tagifyTagData)
              !0 === e && ((t.__tagifyTagData.__isValid = e), delete i.state.editing.locked, i.replaceTag(t))
            })
      },
      ...
      input: {
        ...
        set: function (t, e) {
          ...
          ;(this.input.value = i),
            ...
            !i && n && setTimeout(this.dropdown.hide.bind(this), 20),
            this.input.autocomplete.suggest.call(this),
            this.input.validate.call(this)
        },
        validate: function () {
          var t = !this.input.value || this.validateTag({ value: this.input.value })
          'select' == this.settings.mode
            ? this.DOM.scope.classList.toggle('tagify--invalid', !0 !== t)
      ...
      tagData: function (t, e) {
        return e && (t.__tagifyTagData = c({}, t.__tagifyTagData || {}, e)), t.__tagifyTagData
      },
      ...
      isTagWhitelisted: function (e) {
        return this.settings.whitelist.some(function (t) {
          return 'string' == typeof e
            ? e.trim().toLowerCase() === (t.value || t).toLowerCase()
            : JSON.stringify(t).toLowerCase() === JSON.stringify(e).toLowerCase()
        })
      },
      ...
      replaceTextWithNode: function (t, e) {
        if (this.state.tag || e) {
          ...
          return (
            ...
            ((s = a.splitText(i)).nodeValue = s.nodeValue.replace(e, '')),
      ...
      addEmptyTag: function () {
        ...
        ;(e.__tagifyTagData = t), this.appendTag(e), this.editTag(e, { skipValidation: !0 })
      },
        ...
        return t && 0 != t.length
          ? ((t = this.normalizeTags(t)),
            this.state.editing.scope
              ? ((t[0].__isValid = !0), this.onEditTagDone(this.state.editing.scope, t[0]))
              : 'mix' == r.mode
              ? (r.transformTag.call(this, t[0]),
                (s = this.createTagElem(t[0])),
                this.replaceTextWithNode(s) || this.DOM.input.appendChild(s),
                setTimeout(function () {
                  return s.classList.add('tagify--noAnim')
                }, 300),
                (t[0].prefix =
                  t[0].prefix || this.state.tag ? this.state.tag.prefix : (r.pattern.source || r.pattern)[0]),
                this.value.push(t[0]),
                this.update(),
                (this.state.tag = null),
                this.trigger('add', c({}, { tag: s }, { data: t[0] })),
              ...
              : ('select' == r.mode && (e = !1),
                ...
                t.forEach(function (t) {
                  ...
                  if (
                    ...
                    (t.__isValid = n.hasMaxTags() || n.validateTag(t)),
                    !0 !== t.__isValid)
                  ) {
                    if (a) return
                    c(i, n.getInvaildTagParams(t, t.__isValid)),
                      t.__isValid == n.TEXTS.duplicate && n.markTagByValue(t.value)
                  }
                  if (
                    ((i.role = 'tag'),
                    t.readonly && (i['aria-readonly'] = !0),
                    ((e = n.createTagElem(c({}, t, i))).__tagifyTagData = t),
                    o.push(e),
                    'select' == r.mode)
                  )
      ...
      createTagElem: function (t) {
        ...
        return this.settings.readonly && (t.readonly = !0), ((e = n((s = h(s)))).__tagifyTagData = t), e
      },
      ...
      removeTag: function (t, e, i) {
        if (
          ...
          'select' == this.settings.mode && ((i = 0), this.input.set.call(this)),
            ...
            i && 10 < i
              ? ((t.style.width = parseFloat(window.getComputedStyle(t).width) + 'px'),
        ...
        function o() {
          t.parentNode &&
            ...
            e
              ? s.settings.keepInvalidTags && s.trigger('remove', { tag: t, index: a })
              : (s.update(),
                s.trigger('remove', { tag: t, index: a, data: n }),
                s.dropdown.refilter.call(s),
                s.dropdown.position.call(s),
                s.DOM.input.normalize(),
                s.settings.keepInvalidTags && s.reCheckInvalidTags()))
        }
      },
      ...
      dropdown: {
        init: function () {
          ;(this.DOM.dropdown = n(this.settings.templates.dropdown(this.settings))),
        ...
        show: function (t) {
          ...
          if (!((d && !l) || !1 === o.dropdown.enable || this.state.isLoading)) {
            if (
              (clearTimeout(this.dropdownHide__bindEventsTimeout),
              ...
              if (!t || !l || this.state.editing.scope)
                return (
                  this.input.autocomplete.suggest.call(this),
                  this.dropdown.hide.call(this),
                  void ('select' == o.mode && this.events.binding.call(this))
                )
              this.suggestedListItems = [{ value: t }]
            }
            ;(s = f((i = this.suggestedListItems[0])) ? i.value : i),
              o.autoComplete && s && 0 == s.indexOf(t) && this.input.autocomplete.suggest.call(this, i),
              (e = this.dropdown.createListHTML.call(this, this.suggestedListItems)),
              (this.DOM.dropdown.content.innerHTML = h(e)),
              ((o.enforceWhitelist && !c) || o.dropdown.highlightFirst) &&
        ...
        hide: function (t) {
          ...
          s &&
            ...
            clearTimeout(this.dropdownHide__bindEventsTimeout),
            (this.dropdownHide__bindEventsTimeout = setTimeout(this.events.binding.bind(this), 250)),
        ...
        refilter: function () {
          ...
          ;(this.DOM.dropdown.content.innerHTML = h(t)), this.trigger('dropdown:updated', this.DOM.dropdown)
        },
        position: function (t) {
          var e,
            i,
            ...
            o,
            r = this.DOM.dropdown,
            l = this.DOM['input' == this.settings.dropdown.position ? 'input' : 'scope']
          this.state.dropdown.visible &&
            ((o =
              'text' == this.settings.dropdown.position
                ? ((n = (i = this.getCaretGlobalPosition()).bottom), (s = i.top), (a = i.left), 'auto')
                : ((s = (i = l.getBoundingClientRect()).top), (n = i.bottom - 1), (a = i.left), i.width + 'px')),
            (s = Math.floor(s)),
            (n = Math.ceil(n)),
            (e = document.documentElement.clientHeight - n < (t || r.clientHeight)),
            (r.style.cssText =
              'left:' +
              ...
              ';' +
              (e
                ? 'bottom:' + (document.documentElement.clientHeight - s - window.pageYOffset - 2) + 'px;'
        ...
        events: {
          binding: function (t) {
            ...
            'manual' != this.settings.dropdown.position &&
              (window[n]('resize', s.position), window[n]('keydown', s.onKeyDown)),
              ...
              this.DOM[this.listeners.main.click[0]][n]('click', this.listeners.main.click[1])
          },
          callbacks: {
            onKeyDown: function (t) {
                ...
                case 'Up':
                  ...
                  t.preventDefault(),
                    (i =
                      ...
                      (s = this.DOM.dropdown.content.children)['ArrowUp' == t.key || 'Up' == t.key ? s.length - 1 : 0]),
            ...
            onClick: function (t) {
              if (0 == t.button && t.target != this.DOM.dropdown) {
                var e = t.target.closest('.tagify__dropdown__item')
                t.target.closest('.tagify__dropdown__addNewBtn')
        ...
        highlightOption: function (t, e) {
          ...
          if (
            (this.state.ddItemElm &&
              (this.state.ddItemElm.classList.remove(s), this.state.ddItemElm.removeAttribute('aria-selected')),
            !t)
          )
            return (
          ...
          if (!t)
            return (
              o.duplicates
                ? l
                : l.filter(function (t) {
                    return !a.isTagDuplicate(f(t) ? t.value : t)
                  })
            ).slice(0, d)
          for (
            ;
            h < l.length &&
            ((i = l[h] instanceof Object ? l[h] : { value: l[h] }),
            (s = c
              .reduce(function (t, e) {
                return t + ' ' + (i[e] || '')
              }, '')
            ...
            (e = o.dropdown.fuzzySearch ? 0 <= s : 0 == s),
            (n = !o.duplicates && this.isTagDuplicate(f(i) ? i.value : i)),
            e && !n && d-- && r.push(i),
            0 != d);
            h++
          );
          ...
          return t
            .map(function (t) {
              ...
              var e = s.settings.dropdown.mapValueTo,
                i = c({}, t, {
                  value: a((e ? ('function' == typeof e ? e(t) : t[e]) : t.value) || ''),
                })
