...
export class DLActiveEffects {
  ...
  static async addUpdateEffectsToDocument(document, effectDataList) {
    ...
    if (effectsToAdd.length === 0)
      ...
      // If there are effects to add, delete all previous effects generated by the origin
      await this.removeEffectsByOrigin(document, effectsToAdd[0].origin)
      await document.createEmbeddedDocuments('ActiveEffect', effectDataList, {parent: document})
    }
    return 1
  }
